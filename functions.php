	...
	function jazzclubtownsville_setup() {
		...
		register_nav_menus(
			array(
				...
				'footer-menu' => esc_html__( 'Footer Menu', 'jazzclubtownsville' ),
...
function jazzclubtownsville_scripts() {
	...
	wp_enqueue_script( 'jazzclubtownsville-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
